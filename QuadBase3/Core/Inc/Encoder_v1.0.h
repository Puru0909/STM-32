 ...
 *      Author: Harsh Rahevar
 *
 *  Description:
 *      This header file defines the `Encoder` class and related structures to interface with an
 *      incremental encoder using a timer peripheral. It includes methods to initialize, reset,
 *      update, and retrieve distance measurements in various units.
 */

#ifndef INC_ENCODER_V1_0_H_
#define INC_ENCODER_V1_0_H_
